...
def visualize_moving_buffer_box(objects, buffer_box, initial_bbox_coords, num_time_steps, buffer_box_path):
    ...
    for t in range(num_time_steps):
        ...
        buffer_box.update_box(octree, min_coords, max_coords)  # Update the buffer box coordinates
...
def test_dynamic_octree(objects_initial, time_series_data, output_file, initial_bbox_coords, bbox_update_interval, path_points, buffer_box):
    ...
    with open(output_file, 'w') as file:
        ...
        construction_params = OctreeConstructionParams(max_leaf_size=3, max_leaf_dim=100, slack_factor=1.0)
        ...
        for timestamp, positions in time_series_data.items():
            ...
            visualize_moving_buffer_box(objects_initial, buffer_box, initial_bbox_coords, len(buffer_box_path), buffer_box_path)
...
end_x, end_y = 20, 0       # Ending position of the buffer box
...
# Example object initialization (you can generate your own)
